...
namespace Control_libreria
{
    public partial class frmPrincipal : Form
    {
        ...
        private void autoresToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            dgvGen.AutoResizeColumns();
            conexion.conex().Close();
            //visible y cambio de texto labels y textbox
            txt1.Visible = true;
            txt2.Visible = true;
            txt3.Visible = true;
            txt4.Visible = true;
        ...
        private void dgvGen_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                case "usuarios":
                    var s = dgvGen.Rows[e.RowIndex].Cells[4].Value.ToString();
                    int cboValue;
                    if (s =="1")
                    {
                        cboValue = 0;
                    ...
                    txt2.Text=dgvGen.Rows[e.RowIndex].Cells[1].Value.ToString();
                    txt3.Text = "";
                    txt4.Text=dgvGen.Rows[e.RowIndex].Cells[3].Value.ToString();
                    cboType.SelectedIndex = cboValue;
                    
                    break;
                case "tb_autores":
                    txt1.Text = dgvGen.Rows[e.RowIndex].Cells[0].Value.ToString();
                    txt2.Text = dgvGen.Rows[e.RowIndex].Cells[1].Value.ToString();
                    txt3.Text = dgvGen.Rows[e.RowIndex].Cells[2].Value.ToString();
                    txt4.Text = dgvGen.Rows[e.RowIndex].Cells[3].Value.ToString();
                    break;
                case "tb_editoriales":
                    txt1.Text = dgvGen.Rows[e.RowIndex].Cells[0].Value.ToString();
                    ...
                    txt3.Text = dgvGen.Rows[e.RowIndex].Cells[2].Value.ToString();
                    txt4.Text = dgvGen.Rows[e.RowIndex].Cells[3].Value.ToString();
                    txt5.Text = dgvGen.Rows[e.RowIndex].Cells[4].Value.ToString();
                    break;
                case "tb_temas":
                    txt1.Text = dgvGen.Rows[e.RowIndex].Cells[0].Value.ToString();
                    txt4.Text = dgvGen.Rows[e.RowIndex].Cells[1].Value.ToString();
                    break;
                case "tb_libros":
                    txt1.Text = dgvGen.Rows[e.RowIndex].Cells[0].Value.ToString();
                    txt2.Text = dgvGen.Rows[e.RowIndex].Cells[1].Value.ToString();
                    ...
                    txt4.Text = dgvGen.Rows[e.RowIndex].Cells[3].Value.ToString();
                    txt5.Text = dgvGen.Rows[e.RowIndex].Cells[4].Value.ToString();
                    txt6.Text = dgvGen.Rows[e.RowIndex].Cells[5].Value.ToString();
                    txt7.Text = dgvGen.Rows[e.RowIndex].Cells[6].Value.ToString();
                    txt8.Text = dgvGen.Rows[e.RowIndex].Cells[7].Value.ToString();
                    break;
                case "tb_nacionalidad":
                    txt1.Text = dgvGen.Rows[e.RowIndex].Cells[0].Value.ToString();
                    txt2.Text = dgvGen.Rows[e.RowIndex].Cells[1].Value.ToString();
